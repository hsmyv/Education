                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" method="POST" action="{{route('events.store')}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div>
                                            <input class="form-control" value="{{ old('slug') }}" type="text"
                                                name="slug" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div>
                                            <input class="form-control" value="{{ old('place') }}" type="text"
                                                name="place" />
                                        </div>
                                    </div>
                                     <div class="form-group col-6">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div>
                                            <input class="form-control" value="{{ old('street') }}" type="text"
                                                name="street" />
                                        </div>
                                    </div>
                                     <div class="form-group col-6">
                                        ...
                                        <div>
                                            <input class="form-control" value="{{ old('company') }}" type="text"
                                                name="company" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <img src="/assets/images/banner/nobannerimage.png" id="output"
