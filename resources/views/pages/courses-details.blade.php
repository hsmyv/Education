						...
						<div class="col-lg-9 col-md-8 col-sm-12">
							<div class="courses-post">
								<div class="ttr-post-media media-effect">
									<a href="#"><img src="{{$course->getFirstMediaUrl('images')}}" alt=""></a>
								</div>
								...
								<div class="row">
									<div class="col-md-12 col-lg-4">
										<ul class="course-features">
											...
											<li><i class="ti-check-box"></i> <span class="label">Assessments</span> <span class="value">{{$course->assessments}}</span></li>
										</ul>
									</div>
